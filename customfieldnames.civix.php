 ...
 * extension.
 */
class CRM_LCD_Customfieldnames_ExtensionUtil {
  const SHORT_NAME = 'customfieldnames';
  const LONG_NAME = 'biz.lcdservices.customfieldnames';
  const CLASS_PREFIX = 'CRM_LCD_Customfieldnames';
...
use CRM_LCD_Customfieldnames_ExtensionUtil as E;

function _customfieldnames_civix_mixin_polyfill() {
...
function _customfieldnames_civix_civicrm_config(&$config = NULL) {
  ...
  _customfieldnames_civix_mixin_polyfill();
}
 ...
 */
function _customfieldnames_civix_civicrm_postInstall() {
  _customfieldnames_civix_civicrm_config();
  if ($upgrader = _customfieldnames_civix_upgrader()) {
...
/**
 * @return CRM_LCD_Customfieldnames_Upgrader
 */
function _customfieldnames_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/LCD/Customfieldnames/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_LCD_Customfieldnames_Upgrader_Base::instance();
  }
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _customfieldnames_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _customfieldnames_civix_civicrm_entityTypes(&$entityTypes) {
